(function (a) {
    function g(a, b) {
        ...
        e.val(m.value);
        c.original.val(m.value).change().trigger('change');
        a.data("ddslick", c);
        i(a);
        j(a);
    ...
    function h(b) {
        var c = b.find(".dd-select"),
            ...
            e = c.find(".dd-pointer"),
            f = d.is(":visible");
        a(".dd-click-off-close").not(d).slideUp(0);
            ...
            if (!f) {
                ...
                if (b.clickOffToClose) {
                    ...
                    a("body").on("click", function () {
                        a(".dd-click-off-close").slideUp(0).siblings(".dd-select").find(".dd-pointer").removeClass("dd-pointer-up")
                    })
                }
            }
        })
